...
void MPU9250::initMPU9250(uint8_t MPUnum, uint8_t Ascale, uint8_t Gscale, uint8_t sampleRate)
{
    ...
    writeByte(MPUnum, I2C_MST_DELAY_CTRL, 0x81);
...
void MPU9250::magcalMPU9250(uint8_t MPUnum, float* dest1, float* dest2)
{
    ...
    Serial.print("Mag Calibration for: 0x");
    Serial.println(MPUnum, HEX);
    ...
    {
        writeByte(MPUnum, I2C_SLV0_ADDR, AK8963_ADDRESS | 0x80);
        // Set the I2C slave address of AK8963 and set for read.
        writeByte(MPUnum, I2C_SLV0_REG, AK8963_XOUT_L);
...
void MPU9250::SelfTest(uint8_t MPUnum, float* destination)
