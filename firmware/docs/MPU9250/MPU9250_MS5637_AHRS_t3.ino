...
// First order and second order corrections for raw S5637 temperature and pressure data
...
void MS5637PromRead(uint16_t* destination)
{
    ...
    for (uint8_t ii = 0; ii < 7; ii++)
    {
        ...
        // construct PROM data for return to main program
    }
}
...
uint32_t MS5637Read(uint8_t CMD, uint8_t OSR) // temperature data read
{
    ...
    switch (OSR)
    {
    case ADC_256: delay(1);
        break; // delay for conversion to complete
    case ADC_512: delay(3);
        break;
    case ADC_1024: delay(4);
        break;
    case ADC_2048: delay(6);
        break;
    case ADC_4096: delay(10);
        break;
    case ADC_8192: delay(20);
        break;
    }
