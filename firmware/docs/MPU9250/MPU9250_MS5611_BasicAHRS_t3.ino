 ...
 */
        ...
        getMres();
        magbias[0] = 0;
        //+470.;  // User environmental x-axis correction in milliGauss, should be automatically calculated
...
uint32_t MS5611Read(uint8_t CMD, uint8_t OSR) // temperature data read
{
    ...
    case ADC_512: delay(2);
        break;
    case ADC_1024: delay(3);
        break;
    case ADC_2048: delay(5);
        break;
