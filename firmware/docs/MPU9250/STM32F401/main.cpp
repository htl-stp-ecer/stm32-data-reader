...
int main()
{
    ...
    else
    {
        ...
        lcd.printString("0x", 0, 2);
        lcd.setXYAddress(20, 2);
        lcd.printChar(whoami);
    ...
    while (1)
    {
        ...
        if (delt_t > 500)
        {
            ...
            lcd.setXYAddress(0, 2);
            lcd.printChar((char)(1000 * ax));
            lcd.setXYAddress(20, 2);
            lcd.printChar((char)(1000 * ay));
            lcd.setXYAddress(40, 2);
            lcd.printChar((char)(1000 * az));
            lcd.printString("mg", 66, 2);
