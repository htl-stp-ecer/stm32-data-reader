 ...
 */
#define MPU9250
#include "../../eMPL-hal/mpu9250_hal.h"
#define i2c_write(a, b, c, d) mpu9250_hal_write(a, b, c, d)
#define i2c_read(a, b, c, d)  mpu9250_hal_read(a, b, c, d)
#define delay_ms  mpu9250_hal_delay_ms
#define get_ms    mpu9250_hal_get_clock_ms
