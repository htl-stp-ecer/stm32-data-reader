...
#define TEMPERATUR_SENSOR_SENSITIVITY  333.87f
...
extern inline GyroRangeInfo getInfoFromRange(const GyroRange range);
extern inline AccelRangeInfo getAccelInfoFromRange(const AccelRange range);
extern inline DLPFBandwidthInfo getDLPFInfoFromRange(const DLPFBandwidth range);
extern inline AK8963ModeInfo getAK8963InfoFromMode(const AK8963Mode range);
